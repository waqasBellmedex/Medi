...
insert into ClientAudit(ClientID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Context Name',d.ContextName,i.ContextName,HOST_NAME(),i.UpdatedBy,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.ContextName,'') != ISNULL(d.ContextName,'')
END TRY  
BEGIN CATCH  
    --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
insert into ProviderAudit(ProviderID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Report Tax ID',(case when d.ReportTaxID = 1 then 'Yes' else 'No' end),(case when d.ReportTaxID = 1 then 'Yes' else 'No' end),HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.ReportTaxID,'') != ISNULL(d.ReportTaxID,'')
END TRY  
BEGIN CATCH  
    --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
INSERT INTO ChargeAudit(ChargeID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
SELECT  i.ID, @TransactionID,'Primary Status',(case d.PrimaryStatus when 'N' then 'New Charge' when 'S' then 'Submitted' when 'K' then '999 Accepted' when 'D' then '999 Denied' when 'E' then '999 has Errors' when 'P' then 'Paid' when 'DN' then 'Denial' when 'PT_P' then 'Patient Paid' when 'PPTS' then 'Paid-Transfered To Sec' when 'PPTT' then 'Paid-Transfered To Ter' when 'PPTP' then 'Paid-Transfered To Patient' when 'SPTP' then 'Paid-Transfered To Patient' when 'SPTT' then 'Paid-Transfered To Ter' when 'PR_TP' then 'Pat. Resp. Transferred to Pat' when 'PPTM' then 'Paid-Medigaped' when 'M' then 'Medigaped' Else 'Rejected' end),(case i.PrimaryStatus when 'N' then 'New Charge' when 'S' then 'Submitted' when 'K' then '999 Accepted' when 'D' then '999 Denied' when 'E' then '999 has Errors' when 'P' then 'Paid' when 'DN' then 'Denial' when 'PT_P' then 'Patient Paid' when 'PPTS' then 'Paid-Transfered To Sec' when 'PPTT' then 'Paid-Transfered To Ter' when 'PPTP' then 'Paid-Transfered To Patient' when 'SPTP' then 'Paid-Transfered To Patient' when 'SPTT' then 'Paid-Transfered To Ter' when 'PR_TP' then 'Pat. Resp. Transferred to Pat' when 'PPTM' then 'Paid-Medigaped' when 'M' then 'Medigaped' Else 'Rejected' end),HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
FROM inserted as i
...
if update(Processed)
insert into DownloadedFileAudit(DownloadedFileID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Processed',(case when d.Processed = 1 then 'Yes' else 'No' end),(case when i.Processed = 1 then 'Yes' else 'No' end),HOST_NAME(),i.UpdatedBy,CURRENT_TIMESTAMP
from inserted as i
...
if update(Note)
insert into NotesAudit(NotesID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Notes',d.Note,i.Note,HOST_NAME(),i.UpdatedBy,CURRENT_TIMESTAMP
from inserted as i
...
from inserted as i
inner join deleted as d on i.ID = d.ID and i.Resolved != d.Resolved
END TRY  
BEGIN CATCH  
    --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
FROM inserted as i
INNER JOIN Deleted as d ON i.ID = d.ID and ISNULL(cast(i.CheckDate as date),'') != ISNULL(cast(d.CheckDate as date),'')
END TRY  
BEGIN CATCH  
    --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.OtherPatResp,'') != ISNULL(d.OtherPatResp,'')
END TRY  
BEGIN CATCH  
    --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
--from inserted as i
--inner join deleted as d on i.ID = d.ID and i.FromDate != d.FromDate
--END TRY  
--BEGIN CATCH  
--    --SELECT   
--     print ERROR_NUMBER(); --AS ErrorNumber  
...
--from inserted as i
--inner join deleted as d on i.ID = d.ID and i.ToDate != d.ToDate
--END TRY  
--BEGIN CATCH  
--    --SELECT   
--     print ERROR_NUMBER(); --AS ErrorNumber  
...
--from inserted as i
--inner join deleted as d on i.ID = d.ID and i.FromTime != d.FromTime
--END TRY  
--BEGIN CATCH  
--    --SELECT   
--     print ERROR_NUMBER(); --AS ErrorNumber  
...
--from inserted as i
--inner join deleted as d on i.ID = d.ID and i.ToTime != d.ToTime
--END TRY  
--BEGIN CATCH  
--    --SELECT   
--     print ERROR_NUMBER(); --AS ErrorNumber  
...
if update(Processed)
insert into ReportsLogAudit(ReportsLogID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Processed',(case when d.Processed= 1 then 'Yes' else 'No' end),(case when d.Processed= 1 then 'Yes' else 'No' end),HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.Processed,'') != ISNULL(d.Processed,'')
END TRY  
BEGIN CATCH  
...
insert into ReportsLogAudit(ReportsLogID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'User Resolved',(case when d.UserResolved= 1 then 'Yes' else 'No' end),(case when d.UserResolved= 1 then 'Yes' else 'No' end),HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
...
insert into ReportsLogAudit(ReportsLogID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Manual Import',(case when d.ManualImport= 1 then 'Yes' else 'No' end),(case when d.ManualImport= 1 then 'Yes' else 'No' end),HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
...
if update(Details)
insert into TeamAudit(TeamID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Details',d.Details,i.Details,HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.Details,'') != ISNULL(d.Details,'')
END TRY  
BEGIN CATCH  
    --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.InsurancePlanId,'') != ISNULL(d.InsurancePlanId,'')
Join InsurancePlan as cDel on cDel.ID = ISNULL(d.InsurancePlanId,'')
join InsurancePlan as cUpd on cUpd.ID = ISNULL(i.InsurancePlanId,'')
END TRY  
BEGIN CATCH  
    --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
if update(GroupName)
insert into PatientPlanAudit(PatientPlanID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Group Name',d.GroupName,i.GroupName,HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.GroupName,'') != ISNULL(d.GroupName,'')
END TRY  
BEGIN CATCH  
    --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.InsurancePlanAddressID,'') != ISNULL(d.InsurancePlanAddressID,'')
END TRY  
BEGIN CATCH  
    --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
if update(IsSelfPay)
insert into PatientPlanAudit(PatientPlanID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Is Self Pay',(case when d.IsSelfPay = 1 then 'Yes' else 'No' end),(case when i.IsSelfPay = 1 then 'Yes' else 'No' end),HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.IsSelfPay,'') != ISNULL(d.IsSelfPay,'')
END TRY  
BEGIN CATCH  
    --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
if update(IsValid)
insert into ICDAudit(ICDID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Is Valid',(case when d.IsValid = 1 then 'Yes' else 'No' end),(case when i.IsValid = 1 then 'Yes' else 'No' end),HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.IsValid,'') != ISNULL(d.IsValid,'')
END TRY  
BEGIN CATCH  
...
-- when update BillerID
BEGIN TRY
if update(BillerID)
Select * into #t1 from Biller
...
select i.ID, @TransactionID,'Biller ID',cDel.[FirstName],cUpd.[FirstName],d.BillerID,i.BillerID,HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.BillerID,'') != ISNULL(d.BillerID,'')
Join Biller as cDel on cDel.ID = ISNULL(d.BillerID,'')
join Biller as cUpd on cUpd.ID = ISNULL(i.BillerID,'')	
END TRY  
BEGIN CATCH  
    --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
insert into BatchDocumentAudit(BatchDocumentID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Document Type ID',d.DocumentTypeID,i.DocumentTypeID,HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.DocumentTypeID,'') != ISNULL(d.DocumentTypeID,'')
Join DocumentType as cDel on cDel.ID = ISNULL(d.DocumentTypeID,'')
join DocumentType as cUpd on cUpd.ID = ISNULL(i.DocumentTypeID,'') 
END TRY  
BEGIN CATCH  
    --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
--when update ChargesNumberOfDOS
BEGIN TRY
if update(ChargesNumberOfDOS)
insert into BatchDocumentAudit(BatchDocumentID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Charges Number Of DOS',d.ChargesNumberOfDOS,i.ChargesNumberOfDOS,HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.ChargesNumberOfDOS,'') != ISNULL(d.ChargesNumberOfDOS,'')
END TRY  
BEGIN CATCH  
    --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
--when update ChargesNumberOfDOSEntered
BEGIN TRY
if update(ChargesNumberOfDOSEntered)
insert into BatchDocumentAudit(BatchDocumentID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Charges Number Of DOS Entered',d.ChargesNumberOfDOSEntered,i.ChargesNumberOfDOSEntered,HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.ChargesNumberOfDOSEntered,'') != ISNULL(d.ChargesNumberOfDOSEntered,'')
END TRY  
BEGIN CATCH  
    --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
--when update ChargesTotalCopay
BEGIN TRY
if update(ChargesTotalCopay)
insert into BatchDocumentAudit(BatchDocumentID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Charges Total Copay',d.ChargesTotalCopay,i.ChargesTotalCopay,HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.ChargesTotalCopay,'1') != ISNULL(d.ChargesTotalCopay,'1')
END TRY  
BEGIN CATCH  
    --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
--when update ChargesCopayApplied
BEGIN TRY
if update(ChargesCopayApplied)
insert into BatchDocumentAudit(BatchDocumentID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Charges Copay Applied',d.ChargesCopayApplied,i.ChargesCopayApplied,HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.ChargesCopayApplied,'1') != ISNULL(d.ChargesCopayApplied,'1')
END TRY  
BEGIN CATCH  
    --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
--when update ChargesNumberOfVisits
BEGIN TRY
if update(ChargesNumberOfVisits)
insert into BatchDocumentAudit(BatchDocumentID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Charges Number Of Visits',d.ChargesNumberOfVisits,i.ChargesNumberOfVisits,HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.ChargesNumberOfVisits,'') != ISNULL(d.ChargesNumberOfVisits,'')
END TRY  
BEGIN CATCH  
    --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
--when update ChargesNumberOfVisitsEntered
BEGIN TRY
if update(ChargesNumberOfVisitsEntered)
insert into BatchDocumentAudit(BatchDocumentID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Charges Number Of Visits Entered',d.ChargesNumberOfVisitsEntered,i.ChargesNumberOfVisitsEntered,HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.ChargesNumberOfVisitsEntered,'') != ISNULL(d.ChargesNumberOfVisitsEntered,'')
END TRY  
BEGIN CATCH  
    --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
--when update ChargesStartDate
BEGIN TRY
if update(ChargesStartDate)
insert into BatchDocumentAudit(BatchDocumentID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Charges Start Date',d.ChargesStartDate,i.ChargesStartDate,HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(Cast(i.ChargesStartDate as datetime),'') != ISNULL(cast(d.ChargesStartDate as datetime),'')
END TRY  
BEGIN CATCH  
    --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
--when update ChargesEndTime
BEGIN TRY
if update(ChargesEndTime)
insert into BatchDocumentAudit(BatchDocumentID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Charges End Time',d.ChargesEndTime,i.ChargesEndTime,HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(cast(i.ChargesEndTime as datetime),'') != ISNULL(cast(d.ChargesEndTime as datetime),'')
END TRY  
BEGIN CATCH  
    --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
--when update ChargeNotes
BEGIN TRY
if update(ChargeNotes)
insert into BatchDocumentAudit(BatchDocumentID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Charge Notes',d.ChargeNotes,i.ChargeNotes,HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.ChargeNotes,'') != ISNULL(d.ChargeNotes,'')
END TRY  
BEGIN CATCH  
    --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
--when update AdmitNumberOfPatients
BEGIN TRY
if update(AdmitNumberOfPatients)
insert into BatchDocumentAudit(BatchDocumentID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Admit Number Of Patients',d.AdmitNumberOfPatients,i.AdmitNumberOfPatients,HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.AdmitNumberOfPatients,'') != ISNULL(d.AdmitNumberOfPatients,'')
END TRY  
BEGIN CATCH  
    --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
--when update AdmitNumberOfPatientsEntered
BEGIN TRY
if update(AdmitNumberOfPatientsEntered)
insert into BatchDocumentAudit(BatchDocumentID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Admit Number Of Patients Entered',d.AdmitNumberOfPatientsEntered,i.AdmitNumberOfPatientsEntered,HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.AdmitNumberOfPatientsEntered,'') != ISNULL(d.AdmitNumberOfPatientsEntered,'')
END TRY  
BEGIN CATCH  
    --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
--when update AdmitStartDate
BEGIN TRY
if update(AdmitStartDate)
insert into BatchDocumentAudit(BatchDocumentID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Admit Start Date',d.AdmitStartDate,i.AdmitStartDate,HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(cast(i.AdmitStartDate as datetime),'') != ISNULL(cast(d.AdmitStartDate as datetime),'')
END TRY  
BEGIN CATCH  
    --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
--when update AdmitEndDate
BEGIN TRY
if update(AdmitEndDate)
insert into BatchDocumentAudit(BatchDocumentID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Admit End Date',d.AdmitEndDate,i.AdmitEndDate,HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(cast(i.AdmitEndDate as datetime),'') != ISNULL(cast(d.AdmitEndDate as datetime),'')
END TRY  
BEGIN CATCH  
    --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
--when update AdmitNotes
BEGIN TRY
if update(AdmitNotes)
insert into BatchDocumentAudit(BatchDocumentID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Admit Notes',d.AdmitNotes,i.AdmitNotes,HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.AdmitNotes,'') != ISNULL(d.AdmitNotes,'')
END TRY  
BEGIN CATCH  
    --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
--when update PaymentCheckDate
BEGIN TRY
if update(PaymentCheckDate)
insert into BatchDocumentAudit(BatchDocumentID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Payment Check Date',d.PaymentCheckDate,i.PaymentCheckDate,HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(cast(i.PaymentCheckDate as datetime),'') != ISNULL(Cast(d.PaymentCheckDate as datetime),'')
END TRY  
BEGIN CATCH  
    --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
--when update PaymentAssignedDate
BEGIN TRY
if update(PaymentAssignedDate)
insert into BatchDocumentAudit(BatchDocumentID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Payment Assigned Date',d.PaymentAssignedDate,i.PaymentAssignedDate,HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(Cast(i.PaymentAssignedDate as datetime),'') != ISNULL(cast(d.PaymentAssignedDate as datetime),'')
END TRY  
BEGIN CATCH  
    --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
--when update PaymentTotalAmount
BEGIN TRY
if update(PaymentTotalAmount)
insert into BatchDocumentAudit(BatchDocumentID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Payment Total Amount',d.PaymentTotalAmount,i.PaymentTotalAmount,HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.PaymentTotalAmount,'1') != ISNULL(d.PaymentTotalAmount,'1')
END TRY  
BEGIN CATCH  
    --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
--when update PaymentPlanAmount
BEGIN TRY
if update(PaymentPlanAmount)
insert into BatchDocumentAudit(BatchDocumentID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Payment Plan Amount',d.PaymentPlanAmount,i.PaymentPlanAmount,HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.PaymentPlanAmount,'1') != ISNULL(d.PaymentPlanAmount,'1')
END TRY  
BEGIN CATCH  
    --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
--when update PaymentPlanAppliedAmount
BEGIN TRY
if update(PaymentPlanAppliedAmount)
insert into BatchDocumentAudit(BatchDocumentID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Payment Plan Applied Amount',d.PaymentPlanAppliedAmount,i.PaymentPlanAppliedAmount,HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.PaymentPlanAppliedAmount,'1') != ISNULL(d.PaymentPlanAppliedAmount,'1')
END TRY  
BEGIN CATCH  
    --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
--when update PaymentPatientAmount
BEGIN TRY
if update(PaymentPatientAmount)
insert into BatchDocumentAudit(BatchDocumentID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Payment Patient Amount',d.PaymentPatientAmount,i.PaymentPatientAmount,HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.PaymentPatientAmount,'1') != ISNULL(d.PaymentPatientAmount,'1')
END TRY  
BEGIN CATCH  
    --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
--when update PaymentPatientAppliedAmount
BEGIN TRY
if update(PaymentPatientAppliedAmount)
insert into BatchDocumentAudit(BatchDocumentID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Payment Patient Applied Amount',d.PaymentPatientAppliedAmount,i.PaymentPatientAppliedAmount,HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.PaymentPatientAppliedAmount,'1') != ISNULL(d.PaymentPatientAppliedAmount,'1')
END TRY  
BEGIN CATCH  
    --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
--when update PaymentCopay
BEGIN TRY
if update(PaymentCopay)
insert into BatchDocumentAudit(BatchDocumentID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Payment Copay',d.PaymentCopay,i.PaymentCopay,HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.PaymentCopay,'1') != ISNULL(d.PaymentCopay,'1')
END TRY  
BEGIN CATCH  
    --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
--when update PaymentCopayApplied
BEGIN TRY
if update(PaymentCopayApplied)
insert into BatchDocumentAudit(BatchDocumentID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Payment Copay Applied',d.PaymentCopayApplied,i.PaymentCopayApplied,HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.PaymentCopayApplied,'1') != ISNULL(d.PaymentCopayApplied,'1')
END TRY  
BEGIN CATCH  
    --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
--when update PaymentStartDate
BEGIN TRY
if update(PaymentStartDate)
insert into BatchDocumentAudit(BatchDocumentID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Payment Start Date',d.PaymentStartDate,i.PaymentStartDate,HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(cast(i.PaymentStartDate as datetime),'') != ISNULL(Cast(d.PaymentStartDate as datetime),'')
END TRY  
BEGIN CATCH  
    --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
--when update PaymentEndDate
BEGIN TRY
if update(PaymentEndDate)
insert into BatchDocumentAudit(BatchDocumentID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Payment End Date',d.PaymentEndDate,i.PaymentEndDate,HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(Cast(i.PaymentEndDate as datetime),'') != ISNULL(Cast(d.PaymentEndDate as datetime),'')
END TRY  
BEGIN CATCH  
    --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
--when update PaymentNotes
BEGIN TRY
if update(PaymentNotes)
insert into BatchDocumentAudit(BatchDocumentID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Payment Notes',d.PaymentNotes,i.PaymentNotes,HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.PaymentNotes,'') != ISNULL(d.PaymentNotes,'')
END TRY  
BEGIN CATCH  
    --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.RefProviderID,'') != ISNULL(d.RefProviderID,'')
Join RefProvider as cDel on cDel.ID = ISNULL(d.RefProviderID,'')
join RefProvider as cUpd on cUpd.ID = ISNULL(i.RefProviderID,'')
END TRY  
BEGIN CATCH  
    --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
if update(Statement)
insert into PatientAudit(PatientID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Statement',d.Statement,i.Statement,HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.Statement,'') != ISNULL(d.Statement,'')
END TRY  
BEGIN CATCH  
   --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
insert into PatientAudit(PatientID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Statement Message',d.StatementMessage,i.StatementMessage,HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.StatementMessage,'') != ISNULL(d.StatementMessage,'')
END TRY  
BEGIN CATCH  
 --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.ProviderScheduleID,'') != ISNULL(d.ProviderScheduleID,'')
...
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.RemarkCodeID,'') != ISNULL(d.RemarkCodeID,'')
Join RemarkCode as cDel on cDel.ID = ISNULL(d.RemarkCodeID,'')
join RemarkCode as cUpd on cUpd.ID = ISNULL(i.RemarkCodeID,'')
END TRY  
BEGIN CATCH  
    --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.RemarkCode2ID,'') != ISNULL(d.RemarkCode2ID,'')
Join RemarkCode as cDel on cDel.ID = ISNULL(d.RemarkCode2ID,'')
join RemarkCode as cUpd on cUpd.ID = ISNULL(i.RemarkCode2ID,'')
END TRY  
BEGIN CATCH  
    --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.RemarkCode3ID,'') != ISNULL(d.RemarkCodeID,'')
Join RemarkCode as cDel on cDel.ID = ISNULL(d.RemarkCode3ID,'')
join RemarkCode as cUpd on cUpd.ID = ISNULL(i.RemarkCode3ID,'')
END TRY  
BEGIN CATCH  
    --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.RemarkCode4ID,'') != ISNULL(d.RemarkCode4ID,'')
Join RemarkCode as cDel on cDel.ID = ISNULL(d.RemarkCode4ID,'')
join RemarkCode as cUpd on cUpd.ID = ISNULL(i.RemarkCode4ID,'')
END TRY  
BEGIN CATCH  
    --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
insert into VisitStatusAudit(VisitStatusID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Subscriber LN',d.SubscriberLN,i.SubscriberLN,HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.SubscriberLN,'') != ISNULL(d.SubscriberLN,'')
END TRY  
BEGIN CATCH  
  --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
insert into VisitStatusAudit(VisitStatusID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Subscriber FN',d.SubscriberFN,i.SubscriberFN,HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.SubscriberFN,'') != ISNULL(d.SubscriberFN,'')
END TRY  
BEGIN CATCH  
  --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
insert into VisitStatusAudit(VisitStatusID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Subscriber MI',d.SubscriberMI,i.SubscriberMI,HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.SubscriberMI,'') != ISNULL(d.SubscriberMI,'')
END TRY  
BEGIN CATCH  
  --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
insert into VisitStatusAudit(VisitStatusID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Subscriber Address',d.SubscriberAddress,i.SubscriberAddress,HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.SubscriberAddress,'') != ISNULL(d.SubscriberAddress,'')
END TRY  
BEGIN CATCH  
  --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
insert into VisitStatusAudit(VisitStatusID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Subscriber City',d.SubscriberCity,i.SubscriberCity,HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.SubscriberCity,'') != ISNULL(d.SubscriberCity,'')
END TRY  
BEGIN CATCH  
  --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
insert into VisitStatusAudit(VisitStatusID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Subscriber State',d.SubscriberState,i.SubscriberState,HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.SubscriberState,'') != ISNULL(d.SubscriberState,'')
END TRY  
BEGIN CATCH  
  --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
if update(FreeText1)
insert into VisitStatusAudit(VisitStatusID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Free Text1',d.FreeText1,i.FreeText1,HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.FreeText1,'') != ISNULL(d.FreeText1,'')
END TRY  
BEGIN CATCH  
  --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
if update(FreeText2)
insert into VisitStatusAudit(VisitStatusID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Free Text2',d.FreeText2,i.FreeText2,HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.FreeText2,'') != ISNULL(d.FreeText2,'')
END TRY  
BEGIN CATCH  
  --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
if update(FreeText3)
insert into VisitStatusAudit(VisitStatusID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Free Text3',d.FreeText3,i.FreeText3,HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.FreeText3,'') != ISNULL(d.FreeText3,'')
END TRY  
BEGIN CATCH  
  --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.PatientEligibilityID,'') != ISNULL(d.PatientEligibilityID,'')
END TRY  
BEGIN CATCH  
  --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
if update(PlanName)
insert into PatientEligibilityDetailAudit(PatientEligibilityDetailID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Plan Name',d.PlanName,i.PlanName,HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.PlanName,'') != ISNULL(d.PlanName,'')
END TRY  
BEGIN CATCH  
...
insert into PatientEligibilityDetailAudit(PatientEligibilityDetailID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Plan Description',d.PlanDescription,i.PlanDescription,HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.PlanDescription,'') != ISNULL(d.PlanDescription,'')
END TRY  
BEGIN CATCH  
  --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
...
if update([Messages])
insert into PatientEligibilityDetailAudit(PatientEligibilityDetailID,TransactionID,ColumnName,CurrentValue,NewValue,HostName,AddedBy,AddedDate)
select i.ID, @TransactionID,'Messages',d.[Messages],i.[Messages],HOST_NAME(),i.UpdatedBy ,CURRENT_TIMESTAMP
from inserted as i
inner join deleted as d on i.ID = d.ID and ISNULL(i.[Messages],'') != ISNULL(d.[Messages],'')
END TRY  
BEGIN CATCH  
  --SELECT   
     print ERROR_NUMBER(); --AS ErrorNumber  
